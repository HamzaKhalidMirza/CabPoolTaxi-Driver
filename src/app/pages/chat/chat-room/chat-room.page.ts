...
export class ChatRoomPage implements OnInit {
  ...
  async ionViewWillEnter() {
    this.driverData = await this.authService.getCurrentUser();
    this.clientData = await this.authService.getFieldDataFromStorage(
      "chat-clientData"
    );
  ...
  sendMessage() {
    ...
    let chatData: ChatMessage = {
      senderName: this.driverData.username,
      senderId: this.driverData.id,
      senderRole: this.driverData.role,
      receiverName: this.clientData.username,
